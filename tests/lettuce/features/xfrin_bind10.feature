Feature: Xfrin
    ...
    When I send bind10 the command Xfrin retransfer example.org IN 127.0.0.1 56177
    ...
    config commit
    """
    Then I send bind10 the command Xfrin retransfer example.org IN 127.0.0.1 56177
    ...
    A query for example.org type NS to 127.0.0.1:56176 should have rcode NOERROR
    ...
    When I set bind10 configuration Xfrin/zones to [{"master_port": 56176, "name": "example.org", "master_addr": "127.0.0.1"}]
    ...
    config set Xfrout/zone_config[0]/transfer_acl [{"action": "ACCEPT", "from": "127.0.0.1", "key": "example.key."}]
    config commit
    """
    ...
    A query for www.example.org to 127.0.0.1:56176 should have rcode SERVFAIL
    ...
    A query for example. type SOA to 127.0.0.1:56176 should have rcode NOERROR
    ...
    When I send bind10 the command Xfrin refresh example. IN 127.0.0.1 56177
